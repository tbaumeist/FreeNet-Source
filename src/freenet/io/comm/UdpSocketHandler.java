...
//		}
	...
	private boolean getPacket(DatagramPacket packet) {
		try {
			...
			Logger.receivedMessage(this, "Message received from:\t Address: " + packet.getAddress() + "\tLength: " + packet.getLength());
	...
	public void sendPacket(byte[] blockToSend, Peer destination, boolean allowLocalAddresses) throws LocalAddressException {
		...
		Logger.receivedMessage(this, "Message sent to:\t Address:" + packet.getAddress() + "\tLength: " + packet.getLength());
